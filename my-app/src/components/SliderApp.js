...
import SliderClassVersion from './SliderClassVersion';
      ...
      <Styles color={this.state.color}>
        <div className="App">
          <div className="wrapper">
            ...
            <SliderClassVersion color="#FF4136" hexColor="red" handleUpdateColor={this.handleUpdateColor} />
            <SliderClassVersion color="#3D9970" hexColor="green" handleUpdateColor={this.handleUpdateColor} />
            <SliderClassVersion color="#0074D9" hexColor="blue" handleUpdateColor={this.handleUpdateColor} />
          </div>
        </div>
      </Styles>
    );
